...
pageloc 1 0 2651 
@status
n 0 101:08:02:12:29:32;999455372 e 
s 0 101:08:02:12:49:33;999456573 e 
*page 1 0 970 720 iA
@ports
...
a 0 u 13 0 -20 66 hln 100 EXPR=V(%IN+, %IN-)*1+V(1P)*0
...
@text
s 5 40 120 hln 100 PENTODE MODE
s 5 40 130 hln 100 Plate char.
s 5 40 155 hln 100 Plate current
s 5 40 165 hln 100 is -I(VP)
s 5 50 270 hln 80 (UL mode is V(%IN+, %IN-)*.4+V(1P)*.6)
s 5 50 280 hln 80 (Triode mode is   V(%IN+, %IN-)*0+V(1P)*1)
